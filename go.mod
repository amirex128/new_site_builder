...
require (
	...
	git.snappfood.ir/backend/go/packages/sf-http-request v0.0.9
	git.snappfood.ir/backend/go/packages/sf-logger v0.0.19
	...
	git.snappfood.ir/backend/go/packages/sf-routing v0.0.5
	git.snappfood.ir/backend/go/packages/sf-underscore v0.0.2
...
require (
	...
	go.elastic.co/apm/module/apmgoredisv8/v2 v2.7.0 // indirect
	go.elastic.co/apm/module/apmgormv2/v2 v2.7.0 // indirect
	go.elastic.co/apm/module/apmgrpc/v2 v2.7.0 // indirect
