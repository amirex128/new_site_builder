...
type CreateCustomerTicketCommand struct {
	...
	Category    *enums.CustomerTicketCategoryEnum `json:"product_category" validate:"required,enum"`
	Priority    *enums.CustomerTicketPriorityEnum `json:"priority" validate:"required,enum"`
...
type ReplayCustomerTicketCommand struct {
	...
	Status     *enums.CustomerTicketStatusEnum   `json:"status" validate:"required,enum"`
	Category   *enums.CustomerTicketCategoryEnum `json:"product_category" validate:"required,enum"`
