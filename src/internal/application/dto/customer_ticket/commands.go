...
type CreateCustomerTicketCommand struct {
	...
	Category    *enums.TicketCategoryEnum `json:"product_category" nameFa:"دسته بندی" validate:"required,enum"`
	Priority    *enums.TicketPriorityEnum `json:"priority" nameFa:"اولویت" validate:"required,enum"`
...
type ReplayCustomerTicketCommand struct {
	...
	Status     *enums.TicketStatusEnum   `json:"status" nameFa:"وضعیت" validate:"required,enum"`
	Category   *enums.TicketCategoryEnum `json:"product_category" nameFa:"دسته بندی" validate:"required,enum"`
