...
type CreateDiscountCommand struct {
	...
	MaxUsagePerUser *int                    `json:"maxUsagePerUser" nameFa:"تعداد استفاده" validate:"omitempty,gt=0"`
...
type UpdateDiscountCommand struct {
	...
	MaxUsagePerUser *int                    `json:"maxUsagePerUser,omitempty" nameFa:"تعداد استفاده" validate:"omitempty,gt=0"`
