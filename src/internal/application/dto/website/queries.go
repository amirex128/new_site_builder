...
type GetByDomainPageQuery struct {
	Domain *string `json:"domain" validate:"required,domain"`
	SiteID *int64  `json:"siteId,omitempty" validate:"omitempty"`
	Path   *string `json:"path" validate:"required_text=1,200"`
}
...
type GetFiltersSortProductQuery struct {
	common.PaginationRequestDto
	SelectedFilters map[product.ProductFilterEnum][]string `json:"selectedFilters,omitempty" validate:"enum_string_map_optional"`
	SelectedSort    *product.ProductSortEnum               `json:"selectedSort,omitempty" validate:"enum_optional"`
	SiteID          *int64                                 `json:"siteId,omitempty" validate:"omitempty"`
	Domain          *string                                `json:"domain" validate:"required,domain"`
}
