...
type Site struct {
	...
	DomainType string     `json:"domain_type" gorm:"column:domain_type;type:longtext;not null"`
	...
	SiteType   string     `json:"site_type" gorm:"column:site_type;type:longtext;not null"`
