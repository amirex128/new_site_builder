...
type Payment struct {
	...
	PaymentStatusEnum   string     `json:"payment_status_enum" gorm:"column:payment_status_enum;type:longtext;not null"`
	UserType            string     `json:"user_type" gorm:"column:user_type;type:longtext;null"`
