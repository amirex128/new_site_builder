...
import (
	"github.com/amirex128/new_site_builder/internal/api/utils"
...
func NewAuthenticator(authTransientService func(c *gin.Context) service2.IAuthService, identityService service2.IIdentityService) *Authenticator {
