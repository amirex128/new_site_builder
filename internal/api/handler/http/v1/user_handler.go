...
func (h *UserHandler) UpdateProfileUser(c *gin.Context) {
	var params user2.UpdateProfileUserCommand
...
func (h *UserHandler) GetProfileUser(c *gin.Context) {
	var params user2.GetProfileUserQuery
...
func (h *UserHandler) ChargeCreditRequestUser(c *gin.Context) {
	var params user2.ChargeCreditRequestUserCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *UserHandler) UpgradePlanRequestUser(c *gin.Context) {
	var params user2.UpgradePlanRequestUserCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *UserHandler) RegisterUser(c *gin.Context) {
	var params user2.RegisterUserCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *UserHandler) LoginUser(c *gin.Context) {
	var params user2.LoginUserCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *UserHandler) RequestVerifyAndForgetUser(c *gin.Context) {
	var params user2.RequestVerifyAndForgetUserCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *UserHandler) VerifyUser(c *gin.Context) {
	var params user2.VerifyUserQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *UserHandler) AdminGetAllUser(c *gin.Context) {
	var params user2.AdminGetAllUserQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
