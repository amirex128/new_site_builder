...
func (h *RoleHandler) CreateRole(c *gin.Context) {
	var params role2.CreateRoleCommand
...
func (h *RoleHandler) UpdateRole(c *gin.Context) {
	var params role2.UpdateRoleCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *RoleHandler) SetRoleToCustomer(c *gin.Context) {
	var params role2.SetRoleToCustomerCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *RoleHandler) SetRoleToUser(c *gin.Context) {
	var params role2.SetRoleToUserCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *RoleHandler) SetRoleToPlan(c *gin.Context) {
	var params role2.SetRoleToPlanCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *RoleHandler) GetAllPermission(c *gin.Context) {
	var params role2.GetAllPermissionQuery
...
func (h *RoleHandler) GetAllRole(c *gin.Context) {
	var params role2.GetAllRoleQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *RoleHandler) GetRolePermissions(c *gin.Context) {
	var params role2.GetRolePermissionsQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
