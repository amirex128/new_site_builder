...
func (h *TicketHandler) CreateTicket(c *gin.Context) {
	var params ticket2.CreateTicketCommand
...
func (h *TicketHandler) ReplayTicket(c *gin.Context) {
	var params ticket2.ReplayTicketCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *TicketHandler) AdminReplayTicket(c *gin.Context) {
	var params ticket2.AdminReplayTicketCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *TicketHandler) GetByIdTicket(c *gin.Context) {
	var params ticket2.GetByIdTicketQuery
...
func (h *TicketHandler) GetAllTicket(c *gin.Context) {
	var params ticket2.GetAllTicketQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *TicketHandler) AdminGetAllTicket(c *gin.Context) {
	var params ticket2.AdminGetAllTicketQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
