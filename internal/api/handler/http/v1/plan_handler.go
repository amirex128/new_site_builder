...
func (h *PlanHandler) CreatePlan(c *gin.Context) {
	var params plan2.CreatePlanCommand
...
func (h *PlanHandler) UpdatePlan(c *gin.Context) {
	var params plan2.UpdatePlanCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *PlanHandler) DeletePlan(c *gin.Context) {
	var params plan2.DeletePlanCommand
	if !h.validator.ValidateCommand(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *PlanHandler) GetByIdPlan(c *gin.Context) {
	var params plan2.GetByIDPlanQuery
...
func (h *PlanHandler) GetAllPlan(c *gin.Context) {
	var params plan2.GetAllPlanQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
...
func (h *PlanHandler) CalculatePlanPrice(c *gin.Context) {
	var params plan2.CalculatePlanPriceQuery
	if !h.validator.ValidateQuery(c, &params) {
		return
	}
	h.usecase.SetContext(c)
