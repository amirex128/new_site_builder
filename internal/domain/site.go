...
type Site struct {
	...
	DomainType enums2.DomainTypeEnum `json:"domain_type" gorm:"column:domain_type;type:ENUM('domain','subdomain');default:'domain';not null"`
	Name       string                `json:"name" gorm:"column:name;type:longtext;not null"`
	Status     enums2.StatusEnum     `json:"status" gorm:"column:status;type:ENUM('inactive','active','pending');default:'inactive';not null"`
	SiteType   enums2.SiteTypeEnum   `json:"site_type" gorm:"column:site_type;type:ENUM('shop','blog','business');default:'shop';not null"`
...
func (m *Site) GetCustomerID() *int64 {
	return nil
}
