...
type Ticket struct {
	...
	Status     enums2.TicketStatusEnum   `json:"status" gorm:"column:status;type:ENUM('new','in_progress','closed');default:'new';not null"`
	Category   enums2.TicketCategoryEnum `json:"product_category" gorm:"column:product_category;type:ENUM('bug','enhancement','feature_request','question','documentation','financial');default:'bug';not null"`
	...
	Priority   enums2.TicketPriorityEnum `json:"priority" gorm:"column:priority;type:ENUM('low','medium','high','critical');default:'low';not null"`
