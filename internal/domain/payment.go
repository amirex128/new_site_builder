...
type Payment struct {
	...
	PaymentStatusEnum   enums2.StatusEnum   `json:"payment_status_enum" gorm:"column:payment_status_enum;type:ENUM('inactive','active','pending');default:'inactive';not null"`
	UserType            enums2.UserTypeEnum `json:"user_type" gorm:"column:user_type;type:ENUM('user','customer','guest');default:'user';null"`
