...
type User struct {
	...
	VerifyEmail              enums2.StatusEnum   `json:"verify_email" gorm:"column:verify_email;type:ENUM('inactive','active','pending');default:'inactive';null"`
	...
	VerifyPhone              enums2.StatusEnum   `json:"verify_phone" gorm:"column:verify_phone;type:ENUM('inactive','active','pending');default:'inactive';null"`
	IsActive                 enums2.StatusEnum   `json:"is_active" gorm:"column:is_active;type:ENUM('inactive','active','pending');default:'inactive';not null"`
	AiTypeEnum               enums2.AiTypeEnum   `json:"ai_type_enum" gorm:"column:ai_type_enum;type:ENUM('gpt35','gpt4','claude');default:'gpt35';not null"`
	UserTypeEnum             enums2.UserTypeEnum `json:"user_type_enum" gorm:"column:user_type_enum;type:ENUM('user','customer','guest');default:'user';not null"`
