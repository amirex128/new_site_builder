...
import (
	...
	contractStorage "github.com/amirex128/new_site_builder/internal/contract/service"
...
func (u *FileItemUsecase) CreateOrDirectoryItemCommand(params *fileitem2.CreateOrDirectoryItemCommand) (*resp.Response, error) {
...
func (u *FileItemUsecase) DeleteFileItemCommand(params *fileitem2.DeleteFileItemCommand) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
...
func (u *FileItemUsecase) ForceDeleteFileItemCommand(params *fileitem2.ForceDeleteFileItemCommand) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
...
func (u *FileItemUsecase) RestoreFileItemCommand(params *fileitem2.RestoreFileItemCommand) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
...
func (u *FileItemUsecase) UpdateFileItemCommand(params *fileitem2.UpdateFileItemCommand) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
...
func (u *FileItemUsecase) FileOperationCommand(params *fileitem2.FileOperationCommand) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
	...
	case enums2.FileItemRenameOperation:
		...
		_, err := u.storageService.RenameOrMoveFileOrDirectory(
			...
			oldFullPath,
			newFullPath,
			enums2.FileItemPermissionEnum(permission))
		if err != nil {
	...
	case enums2.FileItemMoveOperation:
	...
	case enums2.FileItemCopyOperation:
		if params.NewParentID == nil {
...
func (u *FileItemUsecase) GetByIdsQuery(params *fileitem2.GetByIdsQuery) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
...
func (u *FileItemUsecase) GetDeletedTreeDirectoryQuery(params *fileitem2.GetDeletedTreeDirectoryQuery) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
...
func (u *FileItemUsecase) GetDownloadFileItemByIdQuery(params *fileitem2.GetDownloadFileItemByIdQuery) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
...
func (u *FileItemUsecase) GetTreeDirectoryQuery(params *fileitem2.GetTreeDirectoryQuery) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil || userID == nil {
		return nil, err
	}
