...
type PageUsecase struct {
	*usecase.BaseUsecase
	repo             repository2.IPageRepository
...
func (u *PageUsecase) CreatePageCommand(params *page2.CreatePageCommand) (*resp.Response, error) {
...
func (u *PageUsecase) UpdatePageCommand(params *page2.UpdatePageCommand) (*resp.Response, error) {
...
func (u *PageUsecase) DeletePageCommand(params *page2.DeletePageCommand) (*resp.Response, error) {
	existingPage, err := u.repo.GetByID(*params.ID)
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return nil, resp.NewError(resp.NotFound, "صفحه مورد نظر یافت نشد")
...
func (u *PageUsecase) GetByIdPageQuery(params *page2.GetByIdPageQuery) (*resp.Response, error) {
	if params.ID != nil {
...
func (u *PageUsecase) GetAllPageQuery(params *page2.GetAllPageQuery) (*resp.Response, error) {
...
func (u *PageUsecase) AdminGetAllPageQuery(params *page2.AdminGetAllPageQuery) (*resp.Response, error) {
...
func (u *PageUsecase) GetByPathPageQuery(params *page2.GetByPathPageQuery) (*resp.Response, error) {
