...
func (u *OrderUsecase) CreateOrderRequestCommand(params *order2.CreateOrderRequestCommand) (*resp.Response, error) {
	...
	var newOrder domain2.Order
	if errors.Is(err, gorm.ErrRecordNotFound) {
		newOrder = domain2.Order{
...
func (u *OrderUsecase) CreateOrderVerifyCommand(params *order2.CreateOrderVerifyCommand) (*resp.Response, error) {
...
func (u *OrderUsecase) GetAllOrderCustomerQuery(params *order2.GetAllOrderCustomerQuery) (*resp.Response, error) {
	customerID, err := u.AuthContext(u.Ctx).GetCustomerID()
	if err != nil {
		return nil, err
	}
...
func (u *OrderUsecase) GetOrderCustomerDetailsQuery(params *order2.GetOrderCustomerDetailsQuery) (*resp.Response, error) {
	customerID, err := u.AuthContext(u.Ctx).GetCustomerID()
	if err != nil {
		return nil, err
	}
...
func (u *OrderUsecase) GetAllOrderUserQuery(params *order2.GetAllOrderUserQuery) (*resp.Response, error) {
...
func (u *OrderUsecase) GetOrderUserDetailsQuery(params *order2.GetOrderUserDetailsQuery) (*resp.Response, error) {
...
func (u *OrderUsecase) AdminGetAllOrderUserQuery(params *order2.AdminGetAllOrderUserQuery) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
		return nil, err
	}
