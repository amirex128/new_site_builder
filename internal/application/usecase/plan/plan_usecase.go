...
import (
	plan2 "github.com/amirex128/new_site_builder/internal/application/dto/plan"
...
func (u *PlanUsecase) CreatePlanCommand(params *plan2.CreatePlanCommand) (*resp.Response, error) {
...
func (u *PlanUsecase) UpdatePlanCommand(params *plan2.UpdatePlanCommand) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
...
func (u *PlanUsecase) DeletePlanCommand(params *plan2.DeletePlanCommand) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
...
func (u *PlanUsecase) GetAllPlanQuery(params *plan2.GetAllPlanQuery) (*resp.Response, error) {
...
func (u *PlanUsecase) GetByIDPlanQuery(params *plan2.GetByIDPlanQuery) (*resp.Response, error) {
...
func (u *PlanUsecase) CalculatePlanPriceQuery(params *plan2.CalculatePlanPriceQuery) (*resp.Response, error) {
