...
import (
	"errors"
	ticket2 "github.com/amirex128/new_site_builder/internal/application/dto/ticket"
...
type TicketUsecase struct {
	*usecase.BaseUsecase
	repo            repository2.ITicketRepository
...
func (u *TicketUsecase) CreateTicketCommand(params *ticket2.CreateTicketCommand) (*resp.Response, error) {
...
func (u *TicketUsecase) ReplayTicketCommand(params *ticket2.ReplayTicketCommand) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil {
		return nil, err
	}
...
func (u *TicketUsecase) AdminReplayTicketCommand(params *ticket2.AdminReplayTicketCommand) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
...
func (u *TicketUsecase) GetByIdTicketQuery(params *ticket2.GetByIdTicketQuery) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil {
		return nil, err
	}
...
func (u *TicketUsecase) GetAllTicketQuery(params *ticket2.GetAllTicketQuery) (*resp.Response, error) {
	userID, err := u.AuthContext(u.Ctx).GetUserID()
	if err != nil {
		return nil, err
	}
...
func (u *TicketUsecase) AdminGetAllTicketQuery(params *ticket2.AdminGetAllTicketQuery) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
		return nil, resp.NewError(resp.Unauthorized, "شما دسترسی به این عملیات را ندارید")
	}
