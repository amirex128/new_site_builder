...
type ProductCategoryUsecase struct {
	*usecase.BaseUsecase
	repo      repository2.IProductCategoryRepository
...
func (u *ProductCategoryUsecase) CreateCategoryCommand(params *product_category2.CreateCategoryCommand) (*resp.Response, error) {
...
func (u *ProductCategoryUsecase) UpdateCategoryCommand(params *product_category2.UpdateCategoryCommand) (*resp.Response, error) {
...
func (u *ProductCategoryUsecase) DeleteCategoryCommand(params *product_category2.DeleteCategoryCommand) (*resp.Response, error) {
...
func (u *ProductCategoryUsecase) GetByIdCategoryQuery(params *product_category2.GetByIdCategoryQuery) (*resp.Response, error) {
...
func (u *ProductCategoryUsecase) GetAllCategoryQuery(params *product_category2.GetAllCategoryQuery) (*resp.Response, error) {
...
func (u *ProductCategoryUsecase) AdminGetAllCategoryQuery(params *product_category2.AdminGetAllCategoryQuery) (*resp.Response, error) {
