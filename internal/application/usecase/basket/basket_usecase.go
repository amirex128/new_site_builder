...
func (u *BasketUsecase) UpdateBasketCommand(params *basket2.UpdateBasketCommand) (*resp.Response, error) {
...
func (u *BasketUsecase) GetBasketQuery(params *basket2.GetBasketQuery) (*resp.Response, error) {
	customerID, err := u.AuthContext(u.Ctx).GetCustomerID()
	if err != nil {
		return nil, err
	}
...
func (u *BasketUsecase) GetAllBasketUserQuery(params *basket2.GetAllBasketUserQuery) (*resp.Response, error) {
	customerID, err := u.AuthContext(u.Ctx).GetCustomerID()
	if err != nil {
		return nil, err
	}
...
func (u *BasketUsecase) AdminGetAllBasketUserQuery(params *basket2.AdminGetAllBasketUserQuery) (*resp.Response, error) {
