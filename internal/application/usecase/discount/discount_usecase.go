...
import (
	...
	"github.com/amirex128/new_site_builder/internal/contract/repository"
...
func (u *DiscountUsecase) CreateDiscountCommand(params *discount2.CreateDiscountCommand) (*resp.Response, error) {
...
func (u *DiscountUsecase) UpdateDiscountCommand(params *discount2.UpdateDiscountCommand) (*resp.Response, error) {
...
func (u *DiscountUsecase) DeleteDiscountCommand(params *discount2.DeleteDiscountCommand) (*resp.Response, error) {
	existingDiscount, err := u.discountRepo.GetByID(*params.ID)
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return nil, resp.NewError(resp.NotFound, "تخفیف یافت نشد")
...
func (u *DiscountUsecase) GetByIdDiscountQuery(params *discount2.GetByIdDiscountQuery) (*resp.Response, error) {
...
func (u *DiscountUsecase) GetAllDiscountQuery(params *discount2.GetAllDiscountQuery) (*resp.Response, error) {
...
func (u *DiscountUsecase) AdminGetAllDiscountQuery(params *discount2.AdminGetAllDiscountQuery) (*resp.Response, error) {
