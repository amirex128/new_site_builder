...
type ProductReviewUsecase struct {
	*usecase.BaseUsecase
	...
	repo        repository2.IProductReviewRepository
...
func (u *ProductReviewUsecase) CreateProductReviewCommand(params *product_review2.CreateProductReviewCommand) (*resp.Response, error) {
...
func (u *ProductReviewUsecase) UpdateProductReviewCommand(params *product_review2.UpdateProductReviewCommand) (*resp.Response, error) {
...
func (u *ProductReviewUsecase) DeleteProductReviewCommand(params *product_review2.DeleteProductReviewCommand) (*resp.Response, error) {
	existingReview, err := u.repo.GetByID(*params.ID)
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return nil, resp.NewError(resp.NotFound, "نظر یافت نشد")
...
func (u *ProductReviewUsecase) GetByIdProductReviewQuery(params *product_review2.GetByIdProductReviewQuery) (*resp.Response, error) {
...
func (u *ProductReviewUsecase) GetAllProductReviewQuery(params *product_review2.GetAllProductReviewQuery) (*resp.Response, error) {
...
func (u *ProductReviewUsecase) AdminGetAllProductReviewQuery(params *product_review2.AdminGetAllProductReviewQuery) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
