...
func (u *PaymentUsecase) VerifyPaymentCommand(params *payment2.VerifyPaymentCommand) (*resp.Response, error) {
...
func (u *PaymentUsecase) CreateOrUpdateGatewayCommand(params *payment2.CreateOrUpdateGatewayCommand) (*resp.Response, error) {
...
func (u *PaymentUsecase) setGatewayValues(gateway *domain2.Gateway, params *payment2.CreateOrUpdateGatewayCommand) {
	...
	if params.IsActiveSaman != nil {
		if *params.IsActiveSaman == enums2.ActiveStatus {
	...
	if params.IsActiveMellat != nil {
		if *params.IsActiveMellat == enums2.ActiveStatus {
	...
	if params.IsActiveParsian != nil {
		if *params.IsActiveParsian == enums2.ActiveStatus {
	...
	if params.IsActivePasargad != nil {
		if *params.IsActivePasargad == enums2.ActiveStatus {
	...
	if params.IsActiveIranKish != nil {
		if *params.IsActiveIranKish == enums2.ActiveStatus {
	...
	if params.IsActiveMelli != nil {
		if *params.IsActiveMelli == enums2.ActiveStatus {
	...
	if params.IsActiveAsanPardakht != nil {
		if *params.IsActiveAsanPardakht == enums2.ActiveStatus {
	...
	if params.IsActiveSepehr != nil {
		if *params.IsActiveSepehr == enums2.ActiveStatus {
	...
	if params.IsActiveZarinPal != nil {
		if *params.IsActiveZarinPal == enums2.ActiveStatus {
	...
	if params.IsActivePayIr != nil {
		if *params.IsActivePayIr == enums2.ActiveStatus {
	...
	if params.IsActiveIdPay != nil {
		if *params.IsActiveIdPay == enums2.ActiveStatus {
	...
	if params.IsActiveYekPay != nil {
		if *params.IsActiveYekPay == enums2.ActiveStatus {
	...
	if params.IsActivePayPing != nil {
		if *params.IsActivePayPing == enums2.ActiveStatus {
	...
	if params.IsActiveParbadVirtual != nil {
		if *params.IsActiveParbadVirtual == enums2.ActiveStatus {
...
func (u *PaymentUsecase) GetByIdGatewayQuery(params *payment2.GetByIdGatewayQuery) (*resp.Response, error) {
...
func (u *PaymentUsecase) AdminGetAllGatewayQuery(params *payment2.AdminGetAllGatewayQuery) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
		return nil, err
	}
...
func (u *PaymentUsecase) RequestGatewayCommand(params *payment2.RequestGatewayCommand) (*resp.Response, error) {
	...
	if *params.UserType == enums2.CustomerTypeValue {
...
func (u *PaymentUsecase) AdminGetAllPaymentQuery(params *payment2.AdminGetAllPaymentQuery) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
		return nil, err
	}
...
func (u *PaymentUsecase) isGatewayActive(gateway *domain2.Gateway, gatewayType enums2.PaymentGatewaysEnum) bool {
	switch gatewayType {
	case enums2.SamanGatewayEnum:
		return gateway.IsActiveSaman == "Active"
	case enums2.MellatGatewayEnum:
		return gateway.IsActiveMellat == "Active"
	case enums2.ParsianGatewayEnum:
		return gateway.IsActiveParsian == "Active"
	case enums2.PasargadGatewayEnum:
		return gateway.IsActivePasargad == "Active"
	case enums2.IranKishGatewayEnum:
		return gateway.IsActiveIranKish == "Active"
	case enums2.MelliGatewayEnum:
		return gateway.IsActiveMelli == "Active"
	case enums2.AsanPardakhtGatewayEnum:
		return gateway.IsActiveAsanPardakht == "Active"
	case enums2.SepehrGatewayEnum:
		return gateway.IsActiveSepehr == "Active"
	case enums2.ZarinPalGatewayEnum:
		return gateway.IsActiveZarinPal == "Active"
	case enums2.PayIrGatewayEnum:
		return gateway.IsActivePayIr == "Active"
	case enums2.IdPayGatewayEnum:
		return gateway.IsActiveIdPay == "Active"
	case enums2.YekPayGatewayEnum:
		return gateway.IsActiveYekPay == "Active"
	case enums2.PayPingGatewayEnum:
		return gateway.IsActivePayPing == "Active"
	case enums2.ParbadVirtualGatewayEnum:
...
func (u *PaymentUsecase) handleChargeCreditVerify(payment *domain2.Payment, isSuccess bool) bool {
	if !isSuccess {
		return false
	}
...
func (u *PaymentUsecase) handleUpgradePlanVerify(payment *domain2.Payment, isSuccess bool) bool {
	if !isSuccess {
		return false
	}
	var orderData map[string]string
...
func (u *PaymentUsecase) handleCreateOrderVerify(payment *domain2.Payment, isSuccess bool) bool {
	if !isSuccess {
		return false
	}
	var orderData map[string]string
