...
func (u *ProductUsecase) CreateProductCommand(params *product2.CreateProductCommand) (*resp.Response, error) {
	...
	if params.ProductVariants != nil && len(params.ProductVariants) > 0 {
		for _, variantDTO := range params.ProductVariants {
			variant := domain2.ProductVariant{
...
func (u *ProductUsecase) UpdateProductCommand(params *product2.UpdateProductCommand) (*resp.Response, error) {
...
func (u *ProductUsecase) DeleteProductCommand(params *product2.DeleteProductCommand) (*resp.Response, error) {
	existingProduct, err := u.productRepo.GetByID(*params.ID)
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return nil, resp.NewError(resp.NotFound, "محصول یافت نشد")
...
func (u *ProductUsecase) GetByIdProductQuery(params *product2.GetByIdProductQuery) (*resp.Response, error) {
...
func (u *ProductUsecase) GetAllProductQuery(params *product2.GetAllProductQuery) (*resp.Response, error) {
...
func (u *ProductUsecase) GetByFiltersSortProductQuery(params *product2.GetByFiltersSortProductQuery) (*resp.Response, error) {
	filters := make(map[enums2.ProductFilterEnum][]string)
	for k, v := range params.SelectedFilters {
		filters[enums2.ProductFilterEnum(k)] = v
	}
	var sortStr *string
...
func (u *ProductUsecase) GetProductByCategoryQuery(params *product2.GetProductByCategoryQuery) (*resp.Response, error) {
...
func (u *ProductUsecase) GetSingleProductQuery(params *product2.GetSingleProductQuery) (*resp.Response, error) {
...
func (u *ProductUsecase) CalculateProductsPriceQuery(params *product2.CalculateProductsPriceQuery) (*resp.Response, error) {
	response := struct {
	...
	for _, productID := range productIDs {
		...
		var variant domain2.ProductVariant
		...
		if discountFound && !isDiscountUsed {
			if discount.Type == enums2.PercentageDiscountType {
...
func (u *ProductUsecase) AdminGetAllProductQuery(params *product2.AdminGetAllProductQuery) (*resp.Response, error) {
	isAdmin, err := u.AuthContext(u.Ctx).IsAdmin()
	if err != nil || !isAdmin {
