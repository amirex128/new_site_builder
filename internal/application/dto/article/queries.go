...
type GetByFiltersSortArticleQuery struct {
	common.PaginationRequestDto
	SelectedFilters map[enums2.ArticleFilterEnum][]string `json:"selectedFilters,omitempty" nameFa:"فیلترها" form:"selectedFilters" validate:"enum_string_map_optional"`
	SelectedSort    *enums2.ArticleSortEnum               `json:"selectedSort,omitempty" nameFa:"مرتب سازی" form:"selectedSort" validate:"enum_optional"`
	SiteID          *int64                                `json:"siteId" nameFa:"شناسه سایت" form:"siteId" validate:"required"`
}
