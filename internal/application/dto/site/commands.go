...
type CreateSiteCommand struct {
	...
	DomainType *enums2.DomainTypeEnum `json:"domainType" validate:"required,enum" nameFa:"نوع آدرس"`
	Name       *string                `json:"name" validate:"required_text=1 200" nameFa:"نام سایت"`
	Status     *enums2.StatusEnum     `json:"status" validate:"required,enum" nameFa:"وضعیت"`
	SiteType   *enums2.SiteTypeEnum   `json:"siteType" validate:"required,enum" nameFa:"نوع سایت"`
}
...
type UpdateSiteCommand struct {
	...
	DomainType *enums2.DomainTypeEnum `json:"domainType,omitempty" validate:"enum_optional" nameFa:"نوع آدرس"`
	Name       *string                `json:"name,omitempty" validate:"optional_text=1 200" nameFa:"نام سایت"`
	Status     *enums2.StatusEnum     `json:"status,omitempty" validate:"enum_optional" nameFa:"وضعیت"`
	SiteType   *enums2.SiteTypeEnum   `json:"siteType,omitempty" validate:"enum_optional" nameFa:"نوع سایت"`
}
