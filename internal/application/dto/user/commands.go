...
type RequestVerifyAndForgetUserCommand struct {
	...
	Type  *enums2.VerifyTypeEnum `json:"type" validate:"required,enum" nameFa:"نوع"`
}
...
type UpdateProfileUserCommand struct {
	...
	AiTypeEnum         *enums2.AiTypeEnum `json:"aiTypeEnum,omitempty" validate:"enum_optional" nameFa:"نوع AI"`
	UseCustomEmailSmtp *enums2.StatusEnum `json:"useCustomEmailSmtp,omitempty" validate:"enum_optional" nameFa:"استفاده از SMTP سفارشی"`
...
type UnitPriceQuery struct {
	UnitPriceName  *enums2.UnitPriceNameEnum `json:"unitPriceName" validate:"required,enum" nameFa:"نام قیمت واحد"`
...
type ChargeCreditRequestUserCommand struct {
	Gateway             *enums2.PaymentGatewaysEnum `json:"gateway" validate:"required,enum" nameFa:"درگاه"`
