...
func (r *ArticleRepo) GetAll(paginationRequestDto common.PaginationRequestDto) (*common.PaginationResponseDto[domain2.Article], error) {
	var articles []domain2.Article
	var count int64

	query := r.database.Model(&domain2.Article{}).Where("is_deleted = ?", false)
	query.Count(&count)
...
func (r *ArticleRepo) GetAllBySiteID(siteID int64, paginationRequestDto common.PaginationRequestDto) (*common.PaginationResponseDto[domain2.Article], error) {
	var articles []domain2.Article
	var count int64

	query := r.database.Model(&domain2.Article{}).
...
func (r *ArticleRepo) GetAllByCategoryID(categoryID int64, paginationRequestDto common.PaginationRequestDto) (*common.PaginationResponseDto[domain2.Article], error) {
	var articles []domain2.Article
	var count int64
...
func (r *ArticleRepo) GetAllByFilterAndSort(
	siteID int64,
	filters map[enums2.ArticleFilterEnum][]string,
	sort *enums2.ArticleSortEnum,
	paginationRequestDto common.PaginationRequestDto,
) (*common.PaginationResponseDto[domain2.Article], error) {
	var articles []domain2.Article
	var count int64
...
func (r *ArticleRepo) GetByID(id int64) (*domain2.Article, error) {
...
func (r *ArticleRepo) GetBySlug(slug string) (*domain2.Article, error) {
	var article domain2.Article
	result := r.database.
		Where("slug = ?", slug).
		Where("is_deleted = ?", false).
...
func (r *ArticleRepo) GetBySlugAndSiteID(slug string, siteID int64) (*domain2.Article, error) {
	var article domain2.Article
	result := r.database.
		Where("slug = ?", slug).
		Where("site_id = ?", siteID).
...
func (r *ArticleRepo) Create(article *domain2.Article) error {
	return r.database.Create(article).Error
}

func (r *ArticleRepo) Update(article *domain2.Article) error {
	return r.database.Save(article).Error
}

func (r *ArticleRepo) Delete(id int64) error {
	return r.database.Model(&domain2.Article{}).
		Where("id = ?", id).
		Update("is_deleted", true).Error
}

func (r *ArticleRepo) GetArticleMedia(articleID int64) ([]domain2.Media, error) {
...
func (r *ArticleRepo) AddMediaToArticle(articleID int64, mediaID int64) error {
	articleMedia := domain2.ArticleMedia{
		ArticleID: articleID,
		MediaID:   mediaID,
	}
...
func (r *ArticleRepo) RemoveMediaFromArticle(articleID int64, mediaID int64) error {
	return r.database.
		...
		Delete(&domain2.ArticleMedia{}).Error
}
...
func (r *ArticleRepo) GetArticleCategories(articleID int64) ([]domain2.ArticleCategory, error) {
...
func (r *ArticleRepo) AddCategoryToArticle(articleID int64, categoryID int64) error {
	articleCategory := domain2.ArticleArticleCategory{
		ArticleID:  articleID,
...
func (r *ArticleRepo) RemoveCategoryFromArticle(articleID int64, categoryID int64) error {
	return r.database.
		...
		Delete(&domain2.ArticleArticleCategory{}).Error
}
